...
.hero-pill{{display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.2);backdrop-filter:blur(6px);padding:8px 16px;border-radius:50px;font-size:.82rem;font-weight:600;color:#fff;margin-bottom:20px}}.hero-offer{{display:inline-block;background:var(--ac,#f59e0b);color:#fff;font-weight:700;font-size:.88rem;padding:10px 20px;border-radius:10px;margin-bottom:22px;box-shadow:0 6px 20px rgba(0,0,0,.2)}}
