...
.nav-cta{{padding:8px 14px!important;font-size:.75rem!important}}.hero-btns{{flex-direction:column!important;gap:10px!important;align-items:flex-start!important}}.btn-main,.btn-wa,.btn-outline{{padding:12px 24px!important;font-size:.88rem!important;width:auto}}
    ...
    html = (
        ...
        '<div class="claim-modal" id="claimModal" style="display:none"><div class="claim-box" style="max-width:500px"><button class="claim-close" onclick="document.getElementById(\'claimModal\').style.display=\'none\'">&times;</button><h2>\U0001f680 Claim Your Business</h2><p class="claim-sub">Get full control + premium growth tools</p><div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:16px;text-align:left"><div style="background:rgba(99,102,241,.05);border:1px solid rgba(99,102,241,.15);border-radius:10px;padding:12px"><div style="font-size:.65rem;color:#94a3b8;margin-bottom:2px">Growth</div><div style="font-size:1.2rem;font-weight:900;color:#7c3aed">\u20b929<small style="font-size:.65rem;font-weight:400;color:#64748b">/mo</small></div></div><div style="background:rgba(99,102,241,.1);border:2px solid rgba(99,102,241,.3);border-radius:10px;padding:12px;position:relative"><div style="position:absolute;top:-7px;left:50%;transform:translateX(-50%);background:#7c3aed;color:#fff;font-size:.45rem;padding:2px 6px;border-radius:50px;font-weight:700">POPULAR</div><div style="font-size:.65rem;color:#94a3b8;margin-bottom:2px">Premium</div><div style="font-size:1.2rem;font-weight:900;color:#7c3aed">\u20b939<small style="font-size:.65rem;font-weight:400;color:#64748b">/mo</small></div></div></div><div class="claim-features" style="max-height:250px;overflow-y:auto"><div class="cf">\U0001f310 Professional Website</div><div class="cf">\U0001f6d2 Product Catalog</div><div class="cf">\U0001f4c8 Full Analytics Dashboard</div><div class="cf">\U0001f4f7 Social Media Posts</div><div class="cf">\U0001f4f8 QR Code Generator</div><div class="cf">\U0001f4c5 Daily Content</div><div class="cf">\U0001f381 Create Offers</div><div class="cf">\U0001f4cd Google Business Setup</div><div class="cf">\U0001f3a8 Logo Generator</div><div class="cf">\U0001f3ac Promo Video Creator</div><div class="cf">\u270e Edit Website Anytime</div><div class="cf">\U0001f517 Social Links Page</div><div class="cf">\U0001f5bc Gallery Photos</div><div class="cf">\U0001f386 Festival Offers</div><div class="cf">\U0001f4aa Custom Tools (Category Based)</div><div class="cf">\U0001f4f2 WhatsApp Auto-Notifications</div><div class="cf">\U0001f30f Share Website with One Tap</div></div><div style="display:flex;gap:8px;margin-bottom:12px"><div style="flex:1;background:rgba(99,102,241,.08);border:1px solid rgba(99,102,241,.2);border-radius:10px;padding:12px;text-align:center"><div style="font-size:.65rem;color:#94a3b8;margin-bottom:4px">Growth</div><div style="font-size:1.3rem;font-weight:900;color:#7c3aed">\u20b929<small style="font-size:.7rem;font-weight:400">/mo</small></div><div style="font-size:.6rem;color:#64748b;margin-top:4px">Website + Analytics + QR</div></div><div style="flex:1;background:rgba(99,102,241,.12);border:2px solid rgba(99,102,241,.4);border-radius:10px;padding:12px;text-align:center;position:relative"><div style="position:absolute;top:-8px;left:50%;transform:translateX(-50%);background:#7c3aed;color:#fff;font-size:.5rem;padding:2px 8px;border-radius:50px;font-weight:700">POPULAR</div><div style="font-size:.65rem;color:#94a3b8;margin-bottom:4px">Premium</div><div style="font-size:1.3rem;font-weight:900;color:#7c3aed">\u20b939<small style="font-size:.7rem;font-weight:400">/mo</small></div><div style="font-size:.6rem;color:#64748b;margin-top:4px">All tools + Custom features</div></div></div><a href="https://city-maps.online/api/panel/{website_id}" class="claim-btn">Claim Now \u2192</a><button class="claim-skip" onclick="document.getElementById(\'claimModal\').style.display=\'none\';window.open(\'/api/panel/{website_id}\',\'_blank\')">Skip (Testing)</button></div></div>'
        
        f'<footer class="footer"><div style="max-width:900px;margin:0 auto;display:flex;flex-direction:column;align-items:center;gap:16px"><div style="font-weight:700;font-size:1rem;color:#fff">{business_name}</div><div style="font-size:.8rem;color:#64748b">Made with &#10084;&#65039; by <a href="https://city-maps.online" target="_blank" style="color:#00e5ff;text-decoration:none">Kalpdev Digitals</a></div></div></footer>'
