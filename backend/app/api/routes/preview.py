...
AD_SLOTS = """<button onclick="shareWebsite()" style="position:fixed;bottom:20px;left:20px;width:44px;height:44px;border-radius:50%;background:#2563EB;border:none;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 14px rgba(37,99,235,.35);z-index:98;cursor:pointer;animation:wab 3s ease-in-out infinite" title="Share this website"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg></button>
<script data-cfasync="false">function shareWebsite(){var url=location.href;if(navigator.share){navigator.share({title:document.title,url:url})}else{navigator.clipboard.writeText(url);var t=document.createElement("div");t.style.cssText="position:fixed;bottom:80px;left:20px;background:#22c55e;color:#fff;padding:8px 16px;border-radius:50px;font-size:.75rem;font-weight:600;z-index:9999";t.textContent="Link copied!";document.body.appendChild(t);setTimeout(function(){t.remove()},2000)}}</script><div id="dashLoginModal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,.6);z-index:9999;display:none;align-items:center;justify-content:center;padding:20px">
...
.nav-cta{{padding:8px 14px!important;font-size:.75rem!important}}.hero-btns{{flex-direction:column!important;gap:10px!important;align-items:flex-start!important}}.btn-main,.btn-wa,.btn-outline{{padding:12px 24px!important;font-size:.88rem!important;width:auto}}
    ...
    html = (
        ...
        '<section style="padding:50px 24px;background:linear-gradient(180deg,#f8fafc,#ede9fe);text-align:center"><div style="max-width:700px;margin:0 auto"><h2 style="font-size:1.5rem;font-weight:900;color:#1e293b;margin-bottom:6px">Grow Your Business Online</h2><p style="font-size:.85rem;color:#64748b;margin-bottom:24px">Everything you need to manage and grow your digital presence</p><div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;text-align:left">'        '<div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:20px"><h3 style="font-size:.75rem;color:#64748b;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px">Growth</h3><div style="font-size:1.8rem;font-weight:900;color:#7c3aed;margin-bottom:12px">\u20b929<small style="font-size:.7rem;color:#64748b;font-weight:400">/month</small></div><ul style="list-style:none;padding:0;margin:0;font-size:.72rem;color:#475569;line-height:2"><li>\U0001f310 Professional Website</li><li>\U0001f6d2 Product Catalog</li><li>\U0001f4c8 Analytics Dashboard</li><li>\U0001f4f7 Social Media Posts</li><li>\U0001f4f8 QR Code Generator</li><li>\U0001f4c5 Daily Content</li><li>\U0001f381 Create Offers</li><li>\U0001f4cd Google Business Setup</li><li>\U0001f3a8 Logo Generator</li><li>\u270e Edit Website Anytime</li><li>\U0001f517 Social Links Page</li><li>\U0001f5bc Gallery Photos</li><li>\U0001f386 Festival Offers</li></ul></div>'        '<div style="background:#fff;border:2px solid #7c3aed;border-radius:14px;padding:20px;position:relative"><div style="position:absolute;top:-10px;left:50%;transform:translateX(-50%);background:#7c3aed;color:#fff;font-size:.55rem;padding:3px 10px;border-radius:50px;font-weight:700">POPULAR</div><h3 style="font-size:.75rem;color:#64748b;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px">Premium</h3><div style="font-size:1.8rem;font-weight:900;color:#7c3aed;margin-bottom:12px">\u20b939<small style="font-size:.7rem;color:#64748b;font-weight:400">/month</small></div><ul style="list-style:none;padding:0;margin:0;font-size:.72rem;color:#475569;line-height:2"><li>\U0001f310 Professional Website</li><li>\U0001f6d2 Product Catalog</li><li>\U0001f4c8 Analytics Dashboard</li><li>\U0001f4f7 Social Media Posts</li><li>\U0001f4f8 QR Code Generator</li><li>\U0001f4c5 Daily Content</li><li>\U0001f381 Create Offers</li><li>\U0001f4cd Google Business Setup</li><li>\U0001f3a8 Logo Generator</li><li>\U0001f3ac Promo Video Creator</li><li>\u270e Edit Website Anytime</li><li>\U0001f517 Social Links Page</li><li>\U0001f5bc Gallery Photos</li><li>\U0001f386 Festival Offers</li><li>\U0001f4aa Custom Tools (Category)</li><li>\U0001f512 Priority Support</li><li>\U0001f30f Custom Domain</li></ul></div>'        f'</div><a href="https://wa.me/917350785606?text=I%20want%20to%20claim%20my%20business%20website" target="_blank" style="display:inline-block;margin-top:20px;padding:12px 28px;background:linear-gradient(135deg,#7c3aed,#6d28d9);color:#fff;border-radius:10px;font-weight:700;font-size:.85rem;text-decoration:none;box-shadow:0 6px 20px rgba(124,58,237,.3)">Get Started \u2192</a></div></section>'
        ...
        '<div class="claim-modal" id="claimModal" style="display:none"><div class="claim-box"><button class="claim-close" onclick="document.getElementById(\'claimModal\').style.display=\'none\'">&times;</button><h2>\U0001f680 Claim Your Business</h2><p class="claim-sub">Get full control of your website + premium growth tools</p><div class="claim-features"><div class="cf">\u2705 Edit website content anytime</div><div class="cf">\u2705 Add products to your store</div><div class="cf">\u2705 View analytics (visitors, calls, leads)</div><div class="cf">\u2705 Auto social media posts</div><div class="cf">\u2705 Daily WhatsApp content ready to share</div><div class="cf">\u2705 QR code for visiting cards</div><div class="cf">\u2705 Google Business Profile setup guide</div><div class="cf">\u2705 Festival campaign generator</div><div class="cf">\u2705 Auto chatbot for your customers</div><div class="cf">\u2705 Promo video creator</div><div class="cf">\u2705 Logo generator</div><div class="cf">\u2705 Create & share offers/deals</div><div class="cf">\u2705 Gallery photo management</div><div class="cf">\u2705 Social media links integration</div><div class="cf">\u2705 Share website with one tap</div><div class="cf">\u2705 WhatsApp auto-notifications</div><div class="cf">\u2705 Custom tools based on your business category</div></div><div style="display:flex;gap:8px;margin-bottom:12px"><div style="flex:1;background:rgba(99,102,241,.08);border:1px solid rgba(99,102,241,.2);border-radius:10px;padding:12px;text-align:center"><div style="font-size:.65rem;color:#94a3b8;margin-bottom:4px">Growth</div><div style="font-size:1.3rem;font-weight:900;color:#7c3aed">\u20b929<small style="font-size:.7rem;font-weight:400">/mo</small></div><div style="font-size:.6rem;color:#64748b;margin-top:4px">Website + Analytics + QR</div></div><div style="flex:1;background:rgba(99,102,241,.12);border:2px solid rgba(99,102,241,.4);border-radius:10px;padding:12px;text-align:center;position:relative"><div style="position:absolute;top:-8px;left:50%;transform:translateX(-50%);background:#7c3aed;color:#fff;font-size:.5rem;padding:2px 8px;border-radius:50px;font-weight:700">POPULAR</div><div style="font-size:.65rem;color:#94a3b8;margin-bottom:4px">Premium</div><div style="font-size:1.3rem;font-weight:900;color:#7c3aed">\u20b939<small style="font-size:.7rem;font-weight:400">/mo</small></div><div style="font-size:.6rem;color:#64748b;margin-top:4px">All tools + Custom features</div></div></div><a href="https://city-maps.online/api/panel/{website_id}" class="claim-btn">Claim Now \u2192</a><button class="claim-skip" onclick="document.getElementById(\'claimModal\').style.display=\'none\';window.open(\'/api/panel/{website_id}\',\'_blank\')">Skip (Testing)</button></div></div>'
