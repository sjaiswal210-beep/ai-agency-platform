...
<div class="tools">
{('<a href="/api/org/' + org_id + '/crm/dashboard" target="_blank" class="tool"><div class="emoji">&#128101;</div><div class="name">CRM</div></a>' if 'crm' in enabled_bos_modules and org_id else '')}
{('<a href="/api/org/' + org_id + '/billing/dashboard" target="_blank" class="tool"><div class="emoji">&#129534;</div><div class="name">Billing</div></a>' if 'billing' in enabled_bos_modules and org_id else '')}
...
{('<a href="/api/org/' + org_id + '/subscriptions/dashboard" target="_blank" class="tool"><div class="emoji">&#128257;</div><div class="name">Subscriptions</div></a>' if 'subscriptions' in enabled_bos_modules and org_id else '')}
{('<a href="/api/org/' + org_id + '/job-cards/dashboard" target="_blank" class="tool"><div class="emoji">&#128295;</div><div class="name">Job Cards</div></a>' if 'job_cards' in enabled_bos_modules and org_id else '')}
{('<a href="/api/org/' + org_id + '/custom-orders/dashboard" target="_blank" class="tool"><div class="emoji">&#128203;</div><div class="name">Custom Orders</div></a>' if 'custom_orders' in enabled_bos_modules and org_id else '')}
...
{('<a href="/api/org/' + org_id + '/clinic/dashboard" target="_blank" class="tool"><div class="emoji">&#129657;</div><div class="name">Clinic</div></a>' if 'clinic' in enabled_bos_modules and org_id else '')}
{('<a href="/api/org/' + org_id + '/students/dashboard" target="_blank" class="tool"><div class="emoji">&#127891;</div><div class="name">Students</div></a>' if 'students' in enabled_bos_modules and org_id else '')}
{('<a href="/api/org/' + org_id + '/events/dashboard" target="_blank" class="tool"><div class="emoji">&#127881;</div><div class="name">Events</div></a>' if 'events' in enabled_bos_modules and org_id else '')}
{('<a href="/api/org/' + org_id + '/fleet/dashboard" target="_blank" class="tool"><div class="emoji">&#128663;</div><div class="name">Fleet</div></a>' if 'fleet' in enabled_bos_modules and org_id else '')}
{('<a href="/api/org/' + org_id + '/reminders/dashboard" target="_blank" class="tool"><div class="emoji">&#128276;</div><div class="name">Reminders</div></a>' if 'reminders' in enabled_bos_modules and org_id else '')}
{('<a href="/api/org/' + org_id + '/inventory/dashboard" target="_blank" class="tool"><div class="emoji">&#128230;</div><div class="name">Inventory</div></a>' if 'inventory' in enabled_bos_modules and org_id else '')}
