...
<style>#chatBubble{animation:chatPulse 2s ease infinite}@keyframes chatPulse{0%,100%{box-shadow:0 4px 16px rgba(99,102,241,.4)}50%{box-shadow:0 4px 24px rgba(99,102,241,.7),0 0 0 8px rgba(99,102,241,.1)}}</style><div id="chatBubble" onclick="toggleChat()" style="position:fixed;bottom:70px;right:14px;width:54px;height:54px;background:linear-gradient(135deg,#6366f1,#8b5cf6);border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 4px 20px rgba(99,102,241,.5);z-index:99999;font-size:24px">&#128172;</div>
