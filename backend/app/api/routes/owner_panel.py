...
<div id="chatBubble" onclick="toggleChat()" style="position:fixed;bottom:60px;right:12px;width:44px;height:44px;background:#6366f1;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 4px 16px rgba(99,102,241,.4);z-index:99"><svg width="20" height="20" viewBox="0 0 24 24" fill="#fff"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div>
<div id="chatPanel" style="display:none;position:fixed;bottom:110px;right:12px;width:300px;max-width:85vw;height:380px;background:rgba(15,23,42,.95);backdrop-filter:blur(16px);border:1px solid rgba(255,255,255,.1);border-radius:16px;z-index:99;flex-direction:column;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,.4)">
