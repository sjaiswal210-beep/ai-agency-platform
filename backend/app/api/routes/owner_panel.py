...
.tools{{display:grid;grid-template-columns:repeat(4,1fr);gap:6px;position:relative;z-index:1}}.tool{{background:rgba(255,255,255,.03);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,.06);border-radius:12px;padding:10px 4px;text-align:center;text-decoration:none;color:#fff;transition:all .2s;box-shadow:0 2px 10px rgba(0,0,0,.15),inset 0 1px 0 rgba(255,255,255,.04)}}.tool:active{{transform:scale(.95);box-shadow:0 1px 4px rgba(0,0,0,.2)}}.tool .emoji{{font-size:1.15rem;margin-bottom:3px;display:block}}.tool .name{{font-size:.56rem;font-weight:600;line-height:1.2}}.tool .desc{{display:none}}
