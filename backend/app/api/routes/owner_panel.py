...
<style>#chatBubble{animation:chatPulse 2s ease infinite}@keyframes chatPulse{0%,100%{box-shadow:0 4px 16px rgba(99,102,241,.4)}50%{box-shadow:0 4px 24px rgba(99,102,241,.7),0 0 0 8px rgba(99,102,241,.1)}}</style><div id="chatBubble" onclick="toggleChat()" style="position:fixed;bottom:65px;right:12px;width:52px;height:52px;background:#6366f1;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 4px 16px rgba(99,102,241,.4);z-index:999"><svg width="20" height="20" viewBox="0 0 24 24" fill="#fff"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div>
