...
<section class="sec" id="features-showcase"><div class="sec-label">What You Get</div><div class="sec-title">Your Complete Business Toolkit</div><div class="sec-desc">Everything included &mdash; website, tools, automation, and growth.</div><div class="feat-compact"><div class="feat-row"><div class="feat-item"><span class="feat-ic">&#127760;</span><div><h4>Professional Website</h4><p>Responsive site with services, gallery, map &amp; contact</p></div></div><div class="feat-item"><span class="feat-ic">&#128722;</span><div><h4>Product Catalog</h4><p>Showcase products with prices &amp; Buy Now via WhatsApp</p></div></div><div class="feat-item"><span class="feat-ic">&#128172;</span><div><h4>WhatsApp Orders</h4><p>One-tap enquiry &amp; order button, zero commission</p></div></div></div><div class="feat-row"><div class="feat-item"><span class="feat-ic">&#128200;</span><div><h4>Analytics Dashboard</h4><p>Track views, calls, WhatsApp clicks in real-time</p></div></div><div class="feat-item"><span class="feat-ic">&#128205;</span><div><h4>Google Maps</h4><p>Show up when people search for businesses near them</p></div></div><div class="feat-item"><span class="feat-ic">&#128247;</span><div><h4>Social Content</h4><p>AI-generated daily posts for Instagram &amp; WhatsApp</p></div></div></div><div class="feat-row"><div class="feat-item"><span class="feat-ic">&#128270;</span><div><h4>Lead Discovery</h4><p>Find new customers from Google Maps automatically</p></div></div><div class="feat-item"><span class="feat-ic">&#128231;</span><div><h4>Auto Outreach</h4><p>AI-crafted WhatsApp messages sent to leads for you</p></div></div><div class="feat-item"><span class="feat-ic">&#9889;</span><div><h4>AI Agents</h4><p>Automated lead finding, analysis &amp; outreach bots</p></div></div></div><div class="feat-row"><div class="feat-item"><span class="feat-ic">&#127912;</span><div><h4>Creatives Studio</h4><p>Auto-generate branded posters, stories &amp; banners</p></div></div><div class="feat-item"><span class="feat-ic">&#127909;</span><div><h4>Video Maker</h4><p>Create promo videos for your business in one click</p></div></div><div class="feat-item"><span class="feat-ic">&#128640;</span><div><h4>Growth Tools</h4><p>QR codes, review links, Google profile setup guide</p></div></div></div></div></section>
