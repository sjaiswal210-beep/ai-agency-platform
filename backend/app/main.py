...
<p style="font-size:.95rem;color:#94a3b8;margin-bottom:16px">Find your free business website by searching your business name and area.</p>
<img src="/static/images/hero-banner.png" alt="City Maps - Create Free Websites" style="max-width:280px;border-radius:10px;margin-bottom:14px">
