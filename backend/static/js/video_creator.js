...
function genVideo(){
  ...
  fetch("/api/video/"+window._wid+"/generate-free",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:prompt,custom_text:ct})}).then(function(r){return r.json()}).then(function(d){
